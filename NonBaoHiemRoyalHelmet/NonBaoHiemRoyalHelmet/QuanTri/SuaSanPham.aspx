    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol style="background-color: #F9FBFD" class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="ThemSanPham.aspx" style="font-weight: bold; color: #F19828" class="my-active-link">Sửa sản phẩm</a></li>
            </ol>
        </nav>
        <h2>Sửa sản phẩm</h2>
        <form id="themSanPham" runat="server">
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button CssClass="btn btn-outline-primary" ID="btnCapNhatSanPham" runat="server" Text="Cập nhật sản phẩm" OnClick="btnCapNhatSanPham_Click" />
                    </td>
                </tr>
            </table>
        </form>
